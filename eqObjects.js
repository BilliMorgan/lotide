...
const eqObjects = function (object1, object2) {
  ...
  objectKeys1.forEach((element, index) => {
    // if (element !== objectKeys2[index]) {
    //   booLean = false;
    //   console.log("cheking forEach: " + booLean)
    // } else {
    if (Array.isArray(object1[element]) === true && Array.isArray(object2[element]) === true) {
      booLean = eqArrays(object1[element], object2[element])
      //console.log("isArray boolean:" + booLean)
    } else {
